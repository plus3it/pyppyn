...
Pyppyn could always use more documentation, whether as part of the official
Pyppyn docs, in docstrings, or even on the web in blog posts, articles, and
...
To set up Pyppyn for local development:

1.  Fork [Pyppyn](https://github.com/plus3it/pyppyn) (look for the
    "Fork" button).

2.  Clone your fork locally:

    ```shell
    git clone https://github.com/your_name_here/pyppyn.git && cd pyppyn
    ```
...
[0]: https://github.com/plus3it/pyppyn/issues
[1]: https://travis-ci.org/plus3it/pyppyn/pull_requests
